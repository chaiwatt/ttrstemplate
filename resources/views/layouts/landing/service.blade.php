<section id="services" class="services">
    <div class="container mb-5">
      ...
      <div class="section-title">
        <h2 class="content sarabun">ขั้นตอนการลงทะเบียน</h2>
      </div>

      <div class="row">
        <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
          <div class="icon"><img src="{{asset('assets/landing/img/register/1.png')}}" alt=""></i></div>
          <h4 class="title sarabun"><a href="">ยื่นใบสมัคร</a></h4>
          <p class="description sarabun">ผู้ประกอบการยื่นใบสมัครในระบบ TTRS</p>
        </div>
