...
<link href="{{asset('assets/landing/vendor/venobox/venobox.css')}}" rel="stylesheet">
<link href="{{asset('assets/landing/vendor/owl.carousel/assets/owl.carousel.min.css')}}" rel="stylesheet">
<link href="{{asset('assets/landing/vendor/aos/aos.css')}}" rel="stylesheet">

    <!-- Template Main CSS File -->
<link href="{{asset('assets/landing/css/st.css')}}" rel="stylesheet">
              ...
              <div class="well">
                    ...
                    <div class="row">
                      <div class="card">
                        ...
                        <div class="card-body">
                          <a class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</a>
                        </div>
                      </div>
                      <div class="card">
                        <img src=" http://placehold.it/500x330" class="card-img-top" alt="...">
...
<div class="alert  cookiealert" role="alert">
    <div class="container">
        ...
        <div class="col-sm-2">
            <img src="{{asset('assets/landing/img/ck.png')}}" alt="">
        </div>
        <div class="col-sm-7 col-md-7">
                <b>เว็บไซต์นี้ใช้คุกกี้</b>
                <p> เราใช้คุกกี้เพื่อนำเสนอเนื้อหาและนโยบายที่ท่านอาจสนใจ เพื่อให้ท่านได้รับประสบการ์ที่ดียิ่งขึ้น คลิกเพื่อดู <br>
        ...
        <div class="col-sm-3  col-md-3 mt-3">
           <a href="#" id="btn-cookie" class=" p-3 px-2 btn  btn-outline-secondary rounded-pill">ตั้งค่าคุกกี้</a>
           <a href="#" id="btn-cookie"   class=" p-3 px-2 btn  btn-primary rounded-pill">ตกลง</a>
        </div>
    </div>
</div>
<!-- END Cookie-Alert -->
